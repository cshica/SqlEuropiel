USE [rm_europiel_mty3]
GO
/****** Object:  StoredProcedure [dbo].[mobile_procesa_notificaciones_cita]    Script Date: 15/04/2021 12:43:04 ******/
SET ANSI_NULLS ON
GO
 ...
 BEGIN
	...
	while @currUnirId <= @maxUnirId
	 begin
		...
		select @prevUnirId = id from #temp_citas_unir where id < @currUnirId and borrar = 0
