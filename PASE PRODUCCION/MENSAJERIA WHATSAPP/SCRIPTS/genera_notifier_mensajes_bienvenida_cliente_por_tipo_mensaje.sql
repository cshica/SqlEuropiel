...
GO
/****** Object:  StoredProcedure [dbo].[genera_notifier_mensajes_bienvenida_cliente_por_tipo_mensaje]    Script Date: 19/04/2021 19:08:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/**********************************************************************************************************************/
-- Hace lo mismo que genera_notifier_mensajes_bienvenida_cliente
-- pero permite colocar un filtro para elegir que tipo de mensajes se va cargar
-- @mobile_os =	whatsapp
--				,sms
--				,iOS
--				,android
...
-- CSHICA - 18/04/2021
-- DROP PROC genera_notifier_mensajes_bienvenida_cliente_por_tipo_mensaje
/**********************************************************************************************************************/
DROP PROC IF EXISTS genera_notifier_mensajes_bienvenida_cliente_por_tipo_mensaje
GO
CREATE procedure [dbo].[genera_notifier_mensajes_bienvenida_cliente_por_tipo_mensaje] --genera_notifier_mensajes_bienvenida_cliente_por_tipo_mensaje 'whatsapp'
(
	@mobile_os varchar(20)=null
)
as
 begin
	drop table if exists tblNotifierWhatsApp
