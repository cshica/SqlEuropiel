...
GO
/****** Object:  StoredProcedure [dbo].[recupera_informacion_callcenter]    Script Date: 31/08/2021 12:35:12 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[recupera_informacion_callcenter] (
    @tipo           INT,
    @fecha_ini      DATE,
    @fecha_fin      DATE,
    @cliente        VARCHAR(128),
...
BEGIN
	...
	SELECT id_sucursal, bloque, descripcion
	INTO #tblSucursales
